...
@class SBAssistantWindow; @class _UIStatusBar; @class SUICFlamesView; @class SiriUIHelpButton; @class UIApplication; @class MTLumaDodgePillView; @class UIStatusBar; @class SiriUISiriStatusView; @class _UIRemoteView; 
