...
@class UIApplication; @class SBAssistantWindow; @class _UIStatusBar; @class _UIRemoteView; @class MTLumaDodgePillView; @class UIStatusBar; @class SiriUISiriStatusView; @class SUICFlamesView; @class SiriUIHelpButton; 
