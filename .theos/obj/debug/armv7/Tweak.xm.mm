...
@class SiriUISiriStatusView; @class UIApplication; @class MTLumaDodgePillView; @class SBAssistantWindow; @class UIStatusBar; @class _UIRemoteView; @class SUICFlamesView; @class _UIStatusBar; @class SiriUIHelpButton; 
