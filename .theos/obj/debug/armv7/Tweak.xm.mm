...
@class UIApplication; @class UIStatusBar; @class _UIStatusBar; @class SBAssistantWindow; @class MTLumaDodgePillView; @class SiriUISiriStatusView; @class SiriUIHelpButton; @class _UIRemoteView; @class SUICFlamesView; 
