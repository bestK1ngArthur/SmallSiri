...
@class UIApplication; @class _UIRemoteView; @class SiriUIHelpButton; @class UIStatusBar; @class SBAssistantWindow; @class SiriUISiriStatusView; @class _UIStatusBar; @class SUICFlamesView; @class MTLumaDodgePillView; 
