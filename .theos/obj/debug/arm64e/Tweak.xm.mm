...
@class SUICFlamesView; @class _UIRemoteView; @class _UIStatusBar; @class MTLumaDodgePillView; @class SBAssistantWindow; @class SiriUIHelpButton; @class UIStatusBar; @class UIApplication; @class SiriUISiriStatusView; 
