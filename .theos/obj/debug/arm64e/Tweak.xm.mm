...
@class SBAssistantWindow; @class SiriUISiriStatusView; @class UIStatusBar; @class _UIStatusBar; @class SUICFlamesView; @class SiriUIHelpButton; @class _UIRemoteView; @class MTLumaDodgePillView; @class UIApplication; 
